      ...
      <div className="sc-root">
        <section className="sc-hero">
          ...
          <div className="sc-hero-inner">
            ...
            <p className="sc-hero-p">Deliver your message with clarity and confidence, reaching every corner effortlessly.</p>
          </div>
        </section>
        ...
        <section className="sc-about">
          <div className="sc-about-inner">
            <div className="sc-about-left">
              ...
              <h2 className="sc-about-h2">Clear announcements, <em>everywhere</em></h2>
