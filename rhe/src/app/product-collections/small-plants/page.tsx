...
const PRODUCTS: Product[] = [
  { id: "1", name: "Single Cypress",                    size: "DW4031",  image: "/others/small1.png"    },
  { id: "2", name: "Small Fern",                 size: "DW4039", image: "/others/small2.png"     },
  { id: "3", name: "Small Fern R",               size: "DW4039R", image: "/others/small3.png"     },
  { id: "4", name: "Sunset",                    size: "DW4028", image: "/others/small4.png"     },
  { id: "5", name: "Zephyranthes",             size: "DW4017", image: "/others/small5.png"     },
  { id: "6", name: "Juncus",                     size: "DW4037", image: "/others/small6.png" },
  { id: "7", name: "Hippuris",                 size: "DW4009", image: "/others/small7.png"  },
  { id: "8", name: "Moss Bush",              size: "DW4011", image: "/others/small8.png"      },
  { id: "9", name: "Rose",                    size: "DW4036R", image: "/others/small9.png"    },
  { id: "10", name: "Photinia Bush",              size: "DW4001", image: "/others/small10.png"       },
  { id: "11", name: "Bougainvillea Mixed",                size: "DW4008", image: "/others/small11.png"       },
  { id: "12", name: "Gardenia White",                size: "DW4022", image: "/others/small12.png"       },
];
    ...
    <div className={`${cormorant.className}`}>
      ...
      <style>{`
        ...
        .pp-hero {
          width: 100%;
          height: 40vh;
          background-image: url('/projects/proj26.jpeg');
      ...
      <section className="pp-hero">
        ...
        <div className="pp-hero-inner">
          ...
          <p className="pp-hero-subtitle">
            REFINED GREENS FOR A SHARP AND PROFESSIONAL AESTHETIC.
          </p>
        </div>
      </section>
      ...
      <section style={{ width: "100%", background: "#f7f7f7" }}>
        <div className="pp-about-grid">
          ...
          <div className="pp-about-text-col">
            ...
            >
                Our premium collection of artificial small plants is specifically 
                curated to bring texture, color, and life to any planter box arrangement. 
                Designed for versatility, these lifelike greens allow you to customize your 
                decor to fit your exact aesthetic, whether you prefer a minimalist modern look or 
                a lush, dense display
            </p>
            ...
            >
              We offer a complete, end-to-end service that covers everything from selection 
              and supply to professional on-site implementation. Our team works closely with 
              you to realize your vision, expertly installing your chosen designs to ensure a 
              seamless and polished result. Perfect for both residential and commercial projects, 
              our small plant solutions provide a flexible and maintenance-free way to transform standard 
              planters into sophisticated focal points.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ width: "100%", background: "#efefef" }}>
        ...
        <div className="pp-catalog-grid-wrap">
