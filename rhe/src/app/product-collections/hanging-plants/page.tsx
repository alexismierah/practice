...
const PRODUCTS: Product[] = [
  { id: "1", name: "Vines 1",                    size: "HP022",  image: "/others/vines1.png"     },
  { id: "2", name: "Vines 2",                    size: "HP009", image: "/others/vines2.png"     },
  { id: "3", name: "Vines 3",                    size: "HP011", image: "/others/vines3.png"     },
  { id: "4", name: "Vines 4",                    size: "HP014", image: "/others/vines4.png"     },
  { id: "5", name: "Galium Spurium",             size: "BC010W", image: "/others/galium.png"     },
  { id: "6", name: "Flattering Wind",            size: "BC007", image: "/others/fluttering.png" },
  { id: "7", name: "Pepepromia",                 size: "BC009YG", image: "/others/peperomia.png"  },
  { id: "8", name: "Green Fructus",              size: "BC005", image: "/others/green.png"      },
  { id: "9", name: "Cabbage",                    size: "BC021Y", image: "/others/cabbage.png"    },
  { id: "10", name: "Gardenia Red",              size: "BC029R", image: "/others/red.png"       },
  { id: "11", name: "Red Blooms",                size: "BC004", image: "/others/vines5.png"       },
];
      ...
      <section className="pp-hero">
        ...
        <div className="pp-hero-inner">
          ...
          <p className="pp-hero-subtitle">
            TURN EMPTY HEIGHTS INTO GREEN HIGHLIGHTS
          </p>
        </div>
      </section>
      ...
      <section style={{ width: "100%", background: "#f7f7f7" }}>
        <div className="pp-about-grid">
          ...
          <div className="pp-about-text-col">
            ...
            >
              Designed to elevate vertical spaces with natural movement and depth, 
              our hanging artificial plants replicate the soft flow and trailing beauty 
              of real foliage. Each piece is carefully crafted to capture realistic texture, 
              color variation, and fullness, making it suitable for enhancing walls, ceilings, 
              beams, and other elevated interior features without the need for maintenance.
            </p>
            ...
            >
              Every arrangement arrives ready to hang, allowing for quick and 
              effortless installation in any space. Whether used as a single accent 
              or combined to create fuller layered displays, these hanging greens provide 
              a flexible way to introduce a refreshing natural feel to both residential and 
