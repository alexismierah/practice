...
const PRODUCTS: Product[] = [
  { id: "1",  name: "Lawn Grass",     size: "25m×2m",   price: "$20.00", oldPrice: "$34.00", image: "/turfgrass/turf10.png"    },
  { id: "2",  name: "Golf Grass",    size: "25m×2m", price: "$20.00", oldPrice: "$34.00", image: "/turfgrass/turf9.png"     },
];
    ...
    <div className={`${cormorant.className}`}>
      ...
      <section
        style={{
          width: "100%",
          height: "285px",
          backgroundImage: "url('/turfgrass/turf6.webp')",
